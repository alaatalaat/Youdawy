...
@Component({
  selector: 'app-about-yodawy',
  templateUrl: './about-yodawy.component.html',
  styleUrls: ['./about-yodawy.component.css'],
})
export class AboutYodawyComponent implements OnInit {
  constructor() {}
